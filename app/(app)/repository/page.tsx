    ...
    <div className="dash-wrapper animate-slide-up">
      <header className="dash-header">
        <div className="dash-header-title">
          <div className="dash-meta">DOCUMENT REPOSITORY</div>
          <h1>Repository</h1>
          <p>View, manage, and verify your previously anchored records.</p>
        </div>
      </header>

      <div className="dash-grid">
        <div className="dash-main-col" style={{ gridColumn: 'span 12' }}>
          <div className="dash-doc-tabs" style={{ maxWidth: 400, marginBottom: 20 }}>
          ...
          <HistorySection type={uploadType} refreshTrigger={0} />
        </div>
      </div>
